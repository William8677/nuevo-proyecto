...
class LocationTrackerImpl(
    ...
    override fun getCurrentLocation(): Flow<Location?> = callbackFlow {
        ...
        fusedLocationClient.getCurrentLocation(
            ...
            Log.e("LocationTracker", "Error fetching location: ${exception.message}")
    ...
    override fun startLocationUpdates(): Flow<Location> = callbackFlow {
        ...
        fusedLocationClient.requestLocationUpdates(locationRequest, locationCallback, null)
            .addOnFailureListener { exception ->
                Log.e("LocationTracker", "Failed to start location updates: ${exception.message}")
                close(exception)
            }
        ...
        Log.e("LocationTracker", "Error during location updates: ${exception.message}")
    }.onCompletion {
        Log.d("LocationTracker", "Location updates completed")
    }
